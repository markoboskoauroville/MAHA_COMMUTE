...
# 10-maha_commute_v10.sh   MAHA COMMUTE v10
#
...
#   night  v10    139059 bytes  sha256 70d1105c4cf3830d
...
#
#   bash 10-maha_commute_v10.sh             ask everything
#   bash 10-maha_commute_v10.sh --offline   install with what is already here
#   bash 10-maha_commute_v10.sh --online    fetch the missing dependencies first
#   bash 10-maha_commute_v10.sh --apps 13   day and all, no picker
#   bash 10-maha_commute_v10.sh --apps all  all three
#   bash 10-maha_commute_v10.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v10"
MAHA_FILE="10-maha_commute_v10.sh"
...
night|night.commute|.nightcommute|v10|8087|the four night trams|night_server.py|four night trams
...
function openSetup(){ refreshDots(); renderPdfMgr(); renderViewGrid(); renderNightSched();
  fetch("version",{cache:"no-store"}).then(r=>r.json())
    .then(v=>{ document.getElementById("verLine").textContent=(v.version||"v10")+" (a) · "+(v.build||""); })
...
printf "\n  ${OK}installed  night.commute v10 (a)${OFF}\n"
...
# MAHA_COMMUTE_SENTINEL v10 5b55a045cafe81d3
