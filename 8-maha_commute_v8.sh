...
# 8-maha_commute_v8.sh   MAHA COMMUTE v8
#
...
#   all    v39    208266 bytes  sha256 f7510f3d4cb8daaa
#
...
#
#   bash 8-maha_commute_v8.sh             ask everything
#   bash 8-maha_commute_v8.sh --offline   install with what is already here
#   bash 8-maha_commute_v8.sh --online    fetch the missing dependencies first
#   bash 8-maha_commute_v8.sh --apps 13   day and all, no picker
#   bash 8-maha_commute_v8.sh --apps all  all three
#   bash 8-maha_commute_v8.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v8"
MAHA_FILE="8-maha_commute_v8.sh"
...
# MAHA_COMMUTE_SENTINEL v8 232759af680f08d2
