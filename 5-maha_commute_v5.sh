...
# 5-maha_commute_v5.sh   MAHA COMMUTE v5
#
...
#
#   bash 5-maha_commute_v5.sh             ask everything
#   bash 5-maha_commute_v5.sh --offline   install with what is already here
#   bash 5-maha_commute_v5.sh --online    fetch the missing dependencies first
#   bash 5-maha_commute_v5.sh --apps 13   day and all, no picker
#   bash 5-maha_commute_v5.sh --apps all  all three
#   bash 5-maha_commute_v5.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v5"
MAHA_FILE="5-maha_commute_v5.sh"
...
# MAHA_COMMUTE_SENTINEL v5 f468ffcab62ea28d
