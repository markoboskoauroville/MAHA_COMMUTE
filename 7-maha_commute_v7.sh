...
# 7-maha_commute_v7.sh   MAHA COMMUTE v7
#
...
#
#   bash 7-maha_commute_v7.sh             ask everything
#   bash 7-maha_commute_v7.sh --offline   install with what is already here
#   bash 7-maha_commute_v7.sh --online    fetch the missing dependencies first
#   bash 7-maha_commute_v7.sh --apps 13   day and all, no picker
#   bash 7-maha_commute_v7.sh --apps all  all three
#   bash 7-maha_commute_v7.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v7"
MAHA_FILE="7-maha_commute_v7.sh"
...
# MAHA_COMMUTE_SENTINEL v7 6682931ae246c523
