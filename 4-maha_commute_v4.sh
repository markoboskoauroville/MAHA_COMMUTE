...
# 4-maha_commute_v4.sh   MAHA COMMUTE v4
#
...
#
#   bash 4-maha_commute_v4.sh             ask everything
#   bash 4-maha_commute_v4.sh --offline   install with what is already here
#   bash 4-maha_commute_v4.sh --online    fetch the missing dependencies first
#   bash 4-maha_commute_v4.sh --apps 13   day and all, no picker
#   bash 4-maha_commute_v4.sh --apps all  all three
#   bash 4-maha_commute_v4.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v4"
MAHA_FILE="4-maha_commute_v4.sh"
...
# MAHA_COMMUTE_SENTINEL v4 67ed7fd632819fdb
