...
# 3-maha_commute_v3.sh   MAHA COMMUTE v3
#
...
#
#   bash 3-maha_commute_v3.sh             ask everything
#   bash 3-maha_commute_v3.sh --offline   install with what is already here
#   bash 3-maha_commute_v3.sh --online    fetch the missing dependencies first
#   bash 3-maha_commute_v3.sh --apps 13   day and all, no picker
#   bash 3-maha_commute_v3.sh --apps all  all three
#   bash 3-maha_commute_v3.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v3"
MAHA_FILE="3-maha_commute_v3.sh"
...
# MAHA_COMMUTE_SENTINEL v3 1491252efd747d67
