...
# 1-maha_commute_v1.sh   MAHA COMMUTE v1
#
...
#
# built            2026-08-27 18:34 UTC
# payloads, as carried, key stripped:
#   day    v13    184996 bytes  sha256 c8ada63a1698e6c6
#   night  v9      90416 bytes  sha256 4afc5edb03984941
#   all    v39    205711 bytes  sha256 8f05fbb587cc322e
#
...
#
#   bash 1-maha_commute_v1.sh             ask everything
#   bash 1-maha_commute_v1.sh --offline   install with what is already here
#   bash 1-maha_commute_v1.sh --online    fetch the missing dependencies first
#   bash 1-maha_commute_v1.sh --apps 13   day and all, no picker
#   bash 1-maha_commute_v1.sh --apps all  all three
#   bash 1-maha_commute_v1.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v1"
MAHA_FILE="1-maha_commute_v1.sh"
...
# MAHA_COMMUTE_SENTINEL v1 af5a1694b6d73deb
