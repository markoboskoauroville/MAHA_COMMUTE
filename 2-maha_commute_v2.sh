...
# 2-maha_commute_v2.sh   MAHA COMMUTE v2
#
...
#
#   bash 2-maha_commute_v2.sh             ask everything
#   bash 2-maha_commute_v2.sh --offline   install with what is already here
#   bash 2-maha_commute_v2.sh --online    fetch the missing dependencies first
#   bash 2-maha_commute_v2.sh --apps 13   day and all, no picker
#   bash 2-maha_commute_v2.sh --apps all  all three
#   bash 2-maha_commute_v2.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v2"
MAHA_FILE="2-maha_commute_v2.sh"
