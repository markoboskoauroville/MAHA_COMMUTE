...
# 9-maha_commute_v9.sh   MAHA COMMUTE v9
#
...
#
#   bash 9-maha_commute_v9.sh             ask everything
#   bash 9-maha_commute_v9.sh --offline   install with what is already here
#   bash 9-maha_commute_v9.sh --online    fetch the missing dependencies first
#   bash 9-maha_commute_v9.sh --apps 13   day and all, no picker
#   bash 9-maha_commute_v9.sh --apps all  all three
#   bash 9-maha_commute_v9.sh --verify    check this file is whole, change nothing
#
...
MAHA_VERSION="v9"
MAHA_FILE="9-maha_commute_v9.sh"
...
# MAHA_COMMUTE_SENTINEL v9 87e7bb73572a0c1e
